...
<html>
<head>
	<title>GPT Athani | View Civil Staff</title>
</head>
	...
	<header class="header">
		...
		<div class="container">
			<div class="container" style="border:solid thick white;border-radius: 10px;">
				<h2 class="well well-sm" style="background-color:transparent; animation-duration: 3s;text-shadow:1px 1px 8px black; color: white"><b>Civil Staff Details</b></h2><br>
						...
						<thead>
							...
							<tbody style="background-color: transparent;">
								<?php
									...
									$sql="select * from staff where branch='CIVIL'";
